...
class Image_vector_store():
    ...
    def __init__(self, collection_name:str, folder_path:str, device:str, model:str='OpenVINO/Phi-3.5-vision-instruct-int4-ov'):
    ...
    def get_caption(self):
        ...
        captions = get_image_caption(question="Describe the image in full detail." ,folder_path=self.folder_path,model=self.model,device=self.device)
        reponse = captions.caption_generation()   
